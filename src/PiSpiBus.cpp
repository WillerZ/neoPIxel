...
using namespace neoPIxel;
  ...
  PiSpiPixel& PiSpiBuffer::operator[](size_t index) { return pixels_[index]; }
  void PiSpiBuffer::display(int fd) const {
    unsigned char const* pBuffer = static_cast<unsigned char const *>(static_cast<void const*>(pixels_.data()));
...
void PiSpiBus::setRed(PiSpiBuffer& buffer, size_t index, unsigned char red) const {
...
void PiSpiBus::setBlue(PiSpiBuffer& buffer, size_t index, unsigned char blue) const {
